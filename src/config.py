...
TRANSLATIONS = {
    "en": {
        ...
        "methodology_point_3": "USD mode converts prices only on exact dates where both the price series and the relevant FX series are available.",
    ...
    "tr": {
        ...
        "methodology_point_3": "USD modu, fiyatları yalnızca hem fiyat serisinin hem de ilgili kur serisinin bulunduğu kesin ortak tarihlerde dönüştürür.",
    ...
    "ru": {
        ...
        "methodology_point_3": "В режиме USD цены конвертируются только в точные даты, где доступны и ценовой ряд, и соответствующий валютный ряд.",
